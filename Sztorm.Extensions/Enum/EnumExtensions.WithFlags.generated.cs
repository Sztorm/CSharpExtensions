...
namespace Sztorm.Extensions.Enum
{
    ...
    {
        private static TEnum Int8WithFlags<TEnum>(this TEnum source, TEnum flags)
            where TEnum : unmanaged, System.Enum
        {
            ref SByte sourceAsInt8 = ref Unsafe.As<TEnum, SByte>(ref source);
            sourceAsInt8 = (SByte)Int64WithFlags(
        ...
        private static TEnum Int16WithFlags<TEnum>(this TEnum source, TEnum flags)
            where TEnum : unmanaged, System.Enum
        {
            ref Int16 sourceAsInt16 = ref Unsafe.As<TEnum, Int16>(ref source);
            sourceAsInt16 = (Int16)Int64WithFlags(
        ...
        private static TEnum Int32WithFlags<TEnum>(this TEnum source, TEnum flags)
            where TEnum : unmanaged, System.Enum
        {
            ref Int32 sourceAsInt32 = ref Unsafe.As<TEnum, Int32>(ref source);
            sourceAsInt32 = (Int32)Int64WithFlags(
        ...
        private static TEnum Int64WithFlags<TEnum>(this TEnum source, TEnum flags)
            where TEnum : unmanaged, System.Enum
        {
            ref Int64 sourceAsInt64 = ref Unsafe.As<TEnum, Int64>(ref source);
            sourceAsInt64 = (Int64)Int64WithFlags(
